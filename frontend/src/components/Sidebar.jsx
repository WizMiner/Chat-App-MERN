...
/**
 * The Sidebar component renders the sidebar of the application.
 * It displays a list of online users and allows the user to select a
 * user to chat with.
...
const Sidebar = () => {
  ...
  /**
   * Filter users to show only the online users if the showOnlineOnly
   * state is true.
